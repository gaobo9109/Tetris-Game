...
public class Island implements Runnable {
	...
	public Island(Metaheuristic metaheuristic, String clusterName, int populationSize, int numGens, MetaheuristicTypes metaheuristicType) throws InstantiationException, IllegalAccessException {
